...
class Brain {
  ...
  Brain(){
    ...
    // satellite pos, satellite vell, sun pos
    numInputs = 2+2+2;
  ...
  PVector getInpulse(PVector satPos, PVector satVel, PVector sunPos){
    ...
    inputs[4] = sunPos.x/width;
    inputs[5] = sunPos.y/(0.63*height);
